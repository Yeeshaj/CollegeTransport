...
/**
 * Created by DELL PC on 24-07-2017.
 */
...
public class MyAdapterDriver extends BaseAdapter
{
    SqlManager sm;
    SQLiteDatabase se;
    private List<ViewDriverDetails> mylist;
    String name;
    private LayoutInflater lf=null;
    Context ctx=null;
    public MyAdapterDriver(Activity activity, List<ViewDriverDetails>mylist)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ViewDriverDetails st=mylist.get(i);
